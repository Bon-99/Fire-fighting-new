function [data, info] = poseGoal
%PoseGoal gives an empty data for hector_uav_msgs/PoseGoal
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'hector_uav_msgs/PoseGoal';
[data.TargetPose, info.TargetPose] = ros.internal.ros.messages.geometry_msgs.poseStamped;
info.TargetPose.MLdataType = 'struct';
info.MessageType = 'hector_uav_msgs/PoseGoal';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
