function [data, info] = poseActionResult
%PoseActionResult gives an empty data for hector_uav_msgs/PoseActionResult
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'hector_uav_msgs/PoseActionResult';
...
[data.Result, info.Result] = ros.internal.ros.custommessages.hector_uav_msgs.poseResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'hector_uav_msgs/PoseActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
