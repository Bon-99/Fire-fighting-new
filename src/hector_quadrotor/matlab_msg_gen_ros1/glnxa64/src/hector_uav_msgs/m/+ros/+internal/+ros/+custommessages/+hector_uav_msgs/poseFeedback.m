function [data, info] = poseFeedback
%PoseFeedback gives an empty data for hector_uav_msgs/PoseFeedback
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'hector_uav_msgs/PoseFeedback';
[data.CurrentPose, info.CurrentPose] = ros.internal.ros.messages.geometry_msgs.poseStamped;
info.CurrentPose.MLdataType = 'struct';
info.MessageType = 'hector_uav_msgs/PoseFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
