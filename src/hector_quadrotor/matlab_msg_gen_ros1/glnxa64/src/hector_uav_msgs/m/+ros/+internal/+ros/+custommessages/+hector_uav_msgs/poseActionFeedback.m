function [data, info] = poseActionFeedback
%PoseActionFeedback gives an empty data for hector_uav_msgs/PoseActionFeedback
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'hector_uav_msgs/PoseActionFeedback';
...
[data.Feedback, info.Feedback] = ros.internal.ros.custommessages.hector_uav_msgs.poseFeedback;
info.Feedback.MLdataType = 'struct';
info.MessageType = 'hector_uav_msgs/PoseActionFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
