function [data, info] = landingActionResult
%LandingActionResult gives an empty data for hector_uav_msgs/LandingActionResult
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'hector_uav_msgs/LandingActionResult';
...
[data.Result, info.Result] = ros.internal.ros.custommessages.hector_uav_msgs.landingResult;
info.Result.MLdataType = 'struct';
info.MessageType = 'hector_uav_msgs/LandingActionResult';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
